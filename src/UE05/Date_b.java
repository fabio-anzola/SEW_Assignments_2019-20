...
public class Date_b {
     ...
     * @param yearTmp  int
     */
    public Date_b(int monthTmp, int dayTmp, int yearTmp) {
     ...
     * @return boolean
     */
    public boolean equals(Date_b hello) {
    ...
    public int dayOfWeek() {
        Date_b newTestDate = new Date_b(1, 1, 1900);
        int addedDays = 0;
    ...
    public void invalidDate() {
        throw new IllegalArgumentException("Ungueltiges Format des Datums!");
    }
}
